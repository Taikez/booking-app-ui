...
import { faBed, faCalendarDays, faCar, faDice, faPerson, faPlane, faTaxi } from "@fortawesome/free-solid-svg-icons"
                        ...
                        {openOptions && <div className="options">
                            <div className="optionItem">
                                ...
                                <div className="optionCounter">
                                    <button className="optionCounterButton" disabled={ options.adult <= 1 } onClick={ ()=> handleOption("adult", "-") }>-</button>
                            ...
                            <div className="optionItem">
                                ...
                                <div className="optionCounter">
                                    <button className="optionCounterButton" disabled={ options.children <= 0 } onClick={ ()=> handleOption("children", "-") }>-</button>
                            ...
                            <div className="optionItem">
                                ...
                                <div className="optionCounter">
                                    <button className="optionCounterButton" disabled={ options.room <= 1 } onClick={ ()=> handleOption("room", "-") }>-</button>
